...
module.exports = async function handler(req,res){
 ...
 try{
  ...
  const payload = {
    ...
    theme:{primary_color:visual.primaryColor,secondary_color:visual.secondaryColor,accent_color:visual.accentColor,logo_url:visual.logoUrl,slogan:visual.slogan},
